...
import torch
import sys
sys.path.append("/local/scratch/a/gprakas/Code/ECE570/utils/utils/cython_merge")
import cython_merge
from cython_merge import merge_cython  # Use the exact name of the .so file (without the extension)
